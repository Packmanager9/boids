...
window.addEventListener('DOMContentLoaded', (event) => {
    ...
    class Boid {
        constructor() {
            this.body = new Circle(Math.random() * canvas.width, Math.random() * canvas.height, 3, getRandomDarkColor(),10* (Math.random() - .5), Math.random() - .5, .99, 1)
        ...
        draw() {
            ...
            this.awarenessbody = new Circle(this.body.x, this.body.y, 80, "transparent")
            this.awarenessbodysmall = new Circle(this.body.x, this.body.y, 30, "transparent")
            ...
            for (let t = 0; t < boids.length; t++) {
                if (boids[t] != this) {
                    ...
                    if(this.awarenessbodysmall.isPointInside(boids[t].body)){
                        this.body.xmom += (this.body.x-boids[t].body.x)/separation.value
                        this.body.ymom += (this.body.y-boids[t].body.y)/separation.value
            ...
            if(count > 0){
                ...
                avgvecx /= count
                avgvecy /= count
                this.body.xmom +=(avgposx-this.body.x)/together.value
                this.body.ymom +=(avgposy-this.body.y)/together.value
    
                this.body.xmom = ((this.body.xmom*(cohesion.value-1))+avgvecx)*(1/(cohesion.value))
                this.body.ymom = ((this.body.ymom*(cohesion.value-1))+avgvecy)*(1/(cohesion.value))
            }
